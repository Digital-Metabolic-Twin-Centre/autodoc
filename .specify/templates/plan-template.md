...
- Review-first documentation automation: explain how generated docstrings,
  Sphinx scaffolds, AutoAPI output, or published pages remain reviewable before
  publication.
...
- Simple, typed service boundaries: map changes to routers, services, utils,
  models, or admin modules and justify any new abstraction or dependency.
...
|-----------|------------|-------------------------------------|
| [e.g., direct default-branch write] | [workflow requirement] | [review branch insufficient because...] |
| [e.g., new provider abstraction] | [specific duplication/risk] | [existing service boundary insufficient because...] |
