...
def generate_docstring_with_openai(code: str, language: str = "python", api_key: str = None, model: str = "gpt-4o-mini") -> Optional[str]:
    """
    ...
    try:
        ...
        response = openai.chat.completions.create(
            model=model,
            messages=[
                {"role": "system", "content": "You are a helpful assistant for generating code docstring."},
