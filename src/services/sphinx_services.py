...
SAMPLE_DOCS_FALLBACK_TEXTS = {
    ...
    "index.rst": (
        ...
        "     <p class=\"eyebrow\">Project Documentation Workspace</p>\n"
        "     <h1>Build documentation that guided project story.</h1>\n"
        "     <p class=\"lead\">\n"
        "       Use this template to capture the arc of the work: what the project is,\n"
        "       what it aims to achieve, how it is progressing, and what the results mean.\n"
        "     </p>\n"
        "   </section>\n\n"
        "Start here\n"
        "----------\n\n"
        "This template is designed to keep technical work easy to follow for supervisors,\n"
        "collaborators, and future contributors.\n\n"
        ".. list-table::\n"
        "   :widths: 24 76\n"
        "   :header-rows: 0\n\n"
        "   * - Project\n"
        "     - Explain the context, goals, plan, and final outcomes.\n"
        "   * - Progress\n"
        "     - Keep a clear running log of weekly movement, blockers, and next steps.\n"
        "   * - Notes\n"
        "     - Store practical documentation for building and maintaining the site.\n\n"
        ".. toctree::\n"
        "   :maxdepth: 1\n"
        "   :caption: Project\n\n"
        "   project/overview\n"
